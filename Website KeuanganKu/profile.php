    ...
    <div class="container">
        ...
        <div class="Profile bg-light">
            <div class="Profile-header d-flex">
                <img src="girl.profile.circle.png" alt="Profile" class="Profile-img">
        ...
        <form class="Account bg-light" method="POST" action="">
            <div class="Account-Header d-flex justify-content-between align-items-center">
                ...
                <div class="btn-Container">
                    ...
                    <button class="btn-Cancel"><a href="indexlogin.php">Cancel</a></button>
                </div>
            </div>
        ...
        <div id="Notification" class="Notification bg-light" style="display:none;">
            ...
            <div class="Notification-Content">
                ...
                <ul class="article-list">
                    <li><a href="artikellogin.php">4 Tips Mengelola Keuangan yang Cocok dengan Karakteristik Gen Z</a></li>
                    <li><a href="artikellogin.php">6 Tahapan Mudah Untuk Pengelolaan Keuangan!</a></li>
                    <li><a href="artikellogin.php">Mengenal OJK dan Fungsinya dalam Mengawasi Pasar Keuangan</a></li>
                    <li><a href="artikellogin.php">Pentingnya Pengelolaan Keuangan Digital untuk wujudkan UMKM yang hebat</a></li>
                    <li><a href="artikellogin.php">Tips Raih Untung Investasi Sesuai Harapan Dengan Melakukan 6 Hal Ini</a></li>
                    <li><a href="artikellogin.php">Nilai tukar rupiah terendah dalam 4 tahun terakhir gara-gara libur lebaran kelamaan</a></li>
                </ul>
